...
public class LoggingAspect {
	...
	@AfterReturning(pointcut = "execution(* com.userservice.service.UserServiceImpl.login(..))", returning = "returnValue")
	...
	@Before("execution(* com.userservice.service.UserServiceImpl.saveuser(..))")
